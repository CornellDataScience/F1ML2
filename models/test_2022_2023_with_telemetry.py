...
avg_br_mae = (results_2022['br_mae'] + results_2023['br_mae']) / 2
avg_lr_mae = (results_2022['lr_mae'] + results_2023['lr_mae']) / 2
...
print(f"  BayesianRidge average:      {avg_br_mae:.3f} grid positions")
print(f"  LinearRegression average:   {avg_lr_mae:.3f} grid positions")
print(f"  Overall average:            {(avg_br_mae + avg_lr_mae)/2:.3f} grid positions")
