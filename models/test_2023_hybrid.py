...
print(f"  MAE (Mean Absolute Error): {mae_br:.3f} grid positions")
...
print(f"  MAE (Mean Absolute Error): {mae_lr:.3f} grid positions")
...
print(f"  Hybrid approach average: {avg_hybrid:.2f}%")
